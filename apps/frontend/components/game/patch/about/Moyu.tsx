...
export const Moyu = () => {
  ...
  return (
    <div className="flex justify-center items-center gap-2 md:pb-4 lg:pb-0">
      ...
      <Link href="https://www.moyu.moe" target="_blank" className="flex items-center gap-2">
        ...
        <span className="flex items-center gap-1">
          ...
          <span className="py-0.5 px-1 rounded-full bg-[hsl(212.02_100%_46.67%/0.2)] text-[hsl(212.02_100%_46.67%)] text-[0.625rem]">
            补丁
          </span>
        </span>
      </Link>
