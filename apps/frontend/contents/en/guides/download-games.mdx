...
| **PotatoVN**     | Hands the download to PotatoVN through `potato-vn://` (requires the PotatoDownload plugin) |
...
LunaBox, ReinaManager and PotatoVN can each be toggled in **Account Settings → Download Settings**; a disabled one no longer appears in the push menu.
