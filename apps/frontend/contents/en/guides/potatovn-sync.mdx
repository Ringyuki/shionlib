...
Click the **<Ellipsis />** menu in the top-right corner of the card and select **Remove from PotatoVN** to delete all of the game's data from PotatoVN cloud, including play time and rating.
