    ...
    const tx = {
      comment: {
        ...
        create: jest.fn().mockResolvedValue({
          ...
          parent: null,
          root_id: null,
          creator: { id: 1, name: 'alice', avatar: null, sponsor_expires_at: null },
          status: 2,
    ...
    prismaService.comment.findMany.mockResolvedValue([
      {
        ...
        parent: {
          id: 10,
          html: '<p>parent</p>',
          creator: { id: 2, name: 'p', avatar: null, sponsor_expires_at: null },
        },
        root_id: 10,
        reply_count: 3,
        liked_users: [{ id: 1 }],
      ...
      items: [
        {
          ...
          parent: {
            id: 10,
            html: '<p>parent</p>',
            creator: { id: 2, name: 'p', avatar: null, is_sponsor: false },
          },
          is_liked: true,
          like_count: 6,
          creator: { id: 1, name: 'alice', avatar: null, is_sponsor: false },
          edited: false,
          status: 1,
          created: new Date('2026-02-18T00:00:00.000Z'),
          updated: new Date('2026-02-18T00:00:00.000Z'),
