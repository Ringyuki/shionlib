...
This is a resource site for visual novels/Galgame. We provide downloads for **game releases** and **translation patches**—free, no barriers, and without speed limits.

If you have questions or suggestions, feel free to open an [Issue](https://github.com/Ringyuki/shionlib/issues) or a [Pull Request](https://github.com/Ringyuki/shionlib/pulls).
